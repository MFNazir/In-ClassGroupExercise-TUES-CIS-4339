...
class DiseasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post diseases_url, params: { disease: { name: @disease.name, timespan: @disease.timespan } }
    end
  ...
  test "should update disease" do
    patch disease_url(@disease), params: { disease: { name: @disease.name, timespan: @disease.timespan } }
